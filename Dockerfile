...
ARG NEXT_PUBLIC_COMMENT_GISCUS_REPO
ARG NEXT_PUBLIC_COMMENT_GISCUS_REPO_ID
ARG NEXT_PUBLIC_COMMENT_GISCUS_CATEGORY_ID
...
ENV NEXT_PUBLIC_COMMENT_GISCUS_REPO $NEXT_PUBLIC_COMMENT_GISCUS_REPO
ENV NEXT_PUBLIC_COMMENT_GISCUS_REPO_ID $NEXT_PUBLIC_COMMENT_GISCUS_REPO_ID
ENV NEXT_PUBLIC_COMMENT_GISCUS_CATEGORY_ID $NEXT_PUBLIC_COMMENT_GISCUS_CATEGORY_ID
WORKDIR /app
